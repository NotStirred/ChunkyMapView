...
public class Renderer {
    ...
    public boolean render(Collection<Tile> tiles, MutableAABBf2d viewExtents) {
...
//        createTexture();
    ...
    public int newTexture(ByteBuffer data) {
